...
namespace Products_Management__version_3.BL
{
    class CLS_PRODUCT
    {
        ...
        //ADD_PRODUCT !!?
        public void ADD_PRODUCT(int ID_cat, string Label_ptoduct, string ID_product,
        ...
        public void UPDATE_PRODUCT(int ID_cat, string Label_ptoduct, string ID_product,
                                 int Qte, string Price, byte[] img)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.Open();
